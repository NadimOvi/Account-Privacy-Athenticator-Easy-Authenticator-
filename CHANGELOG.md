 ...
 * Move: the Github repository was moved from flocke/easyauthenticator to easyauthenticator/easyauthenticator for better organization of collaborators
 ...
 * Bug fix: rename the apps launcher icon to "easyauthenticator" (Issue #6)
