package org.shadowice.flocke.easyauthenticator.Fragments;
...
public class BaseAboutFragment extends Fragment {
    private static final String GITHUB_URI = "https://github.com/easyauthenticator/easyauthenticator";
    ...
    public void copyToClipboard(String uri) {
        ...
        ClipData clip = ClipData.newPlainText("easyauthenticator", uri);
